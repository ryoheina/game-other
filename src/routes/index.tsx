...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Do Not Play ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â An Unfinished Warning" },
