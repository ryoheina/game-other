...
export function IntroOverlay({ onComplete }: { onComplete?: () => void }) {
  ...
  useEffect(() => {
    ...
    if (video) {
      // Muted playback is the only autoplay mode guaranteed by browsers. This
      // keeps the intro video visible even before the visitor interacts.
      video.muted = true;
