...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DWu8LFvm.js
...
var $$splitComponentImporter$1 = () => import("./routes-CLGDejFl.mjs");
...
async function recordVisit(request, data) {
	...
	const { supabaseAdmin } = await import("./client.server-Bq3oRDuy.mjs");
...
var Route$8 = createFileRoute("/api/admin/delete-user")({ server: { handlers: { POST: async ({ request }) => {
	...
	try {
		...
		let supabaseAdmin;
		try {
			supabaseAdmin = (await import("./client.server-Bq3oRDuy.mjs")).supabaseAdmin;
