...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BcJyGoUi.js
...
var $$splitComponentImporter$1 = () => import("./routes-y8vN6HqO.mjs");
...
async function recordVisit(request, data) {
	...
	const { supabaseAdmin } = await import("./client.server-qnH6Icn8.mjs");
...
var Route$8 = createFileRoute("/api/admin/delete-user")({ server: { handlers: { POST: async ({ request }) => {
	...
	try {
		...
		let supabaseAdmin;
		try {
			supabaseAdmin = (await import("./client.server-qnH6Icn8.mjs")).supabaseAdmin;
