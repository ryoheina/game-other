...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Brcncah9.js
...
var $$splitComponentImporter$1 = () => import("./routes-B5-28v6Q.mjs");
...
async function recordVisit(request, data) {
	...
	const { supabaseAdmin } = await import("./client.server-BoV0NSBo.mjs");
...
var Route$8 = createFileRoute("/api/admin/delete-user")({ server: { handlers: { POST: async ({ request }) => {
	...
	try {
		...
		let supabaseAdmin;
		try {
			supabaseAdmin = (await import("./client.server-BoV0NSBo.mjs")).supabaseAdmin;
