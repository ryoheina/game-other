	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: visible && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
				"aria-hidden": true,
				className: "absolute left-1/2 top-1/2 h-[35vmax] w-[35vmax] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(235,250,255,0.98)_0%,rgba(98,202,255,0.86)_12%,rgba(95,94,255,0.44)_32%,transparent_68%)] blur-sm",
				initial: {
					opacity: 0,
					scale: .05
				},
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
				"aria-hidden": true,
				className: "absolute left-1/2 top-1/2 h-[18vmax] w-[18vmax] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-100/80",
				initial: {
					opacity: 0,
					scale: .1
				},
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
				"aria-hidden": true,
				className: "absolute left-1/2 top-1/2 h-[10vmax] w-[10vmax] -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-violet-200/75",
				initial: {
					opacity: 0,
					scale: .1
				},
